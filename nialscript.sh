...
organization=nialVPN
organizationalunit=IT
commonname=nialVPN.xyz
email=admin@nialVPN.xyz
...
wget -O about "$source/about.sh"

# set script permission
chmod +x menu usernew trial hapus cek member speedtest info about
...
echo " "
echo "==NIALSCRIPT============================" | tee -a log-install.txt
...
echo " Reboot 15 Sec"
sleep 15
rm -f /root/nialscript.sh /root/cert.pem /root/jcameron-key.asc /root/key.pem  fo abou